...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/projects/";
          ...
          section: "Navigation",
          handler: () => {
            window.location.href = "/projects/about-redirect/";
          },
        ...
        handler: () => {
            ...
            window.location.href = "/projects/assets/pdf/example_pdf.pdf";
        ...
        handler: () => {
          ...
          section: "Projects",handler: () => {
              window.location.href = "/projects/projects/3_project/";
        ...
        section: 'Socials',
        handler: () => {
          window.open("/projects/assets/pdf/example_pdf.pdf", "_blank");
        },
      },{
        id: 'social-email',
        title: 'email',
        ...
        section: 'Socials',
        handler: () => {
          window.open("/projects/feed.xml", "_blank");
        },
      },{
        id: 'social-scholar',
